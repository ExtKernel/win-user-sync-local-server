...
class Monitor:
    ...
    def monitor_usergroup_change(self):
        ...
        filtered_local_usergroups = filter_by_blacklist(local_usergroups, remote.get_blacklist(
            '/secured/client/Win/usergroup-blacklist',
            SERVER_NAME
        ))
    ...
    def monitor_user_change(self):
        ...
        filtered_local_users = filter_by_blacklist(local_users, remote.get_blacklist(
            '/secured/client/Win/user-blacklist',
            SERVER_NAME
        ))
